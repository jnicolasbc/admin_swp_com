           ...
           <div class="col-lg-12">
		            ...
		            <div id="md-add-event" class="modal fade md-slideUp" tabindex="-1" data-width="450"  data-header-color="inverse">
		            	...
		            	<div class="modal-body" style="padding-bottom:0">
		            		{{Form::open(array('method'=>'GET','class' => 'cmxform form-horizontal adminex-form', 'action' => 'PatientsController@index', 'files' => 'true'))}}
                                ...
                                <div class="form-group ">
                                     ...
                                     <select class="selectpicker form-control" data-size="10" data-live-search="true"  name="specialty">
							...
							<table class="table table-striped" id="table-example">
								...
								<tbody align="center"> 																				
									...
									<tr class="odd gradeX">	
										...
										<td>{{$user->email}}</td>
										<td>{{$profile->phone}}</td>
										<td><a href="{{url('doctor/patient/'.$d->patient_id.'/appointments-pending')}}" type="button" class="btn btn-info btn-transparent" data-toggle="tooltip" data-placement="left" title="Citas Pendientes"><i class="fa fa-clock-o"></i> Pendientes</a>
										    <a href="{{url('doctor/patient/'.$d->patient_id.'/appointments-history')}}" type="button" class="btn btn-info btn-transparent" data-toggle="tooltip" data-placement="left" title="Historia de citas"><i class="fa fa-clock-o"></i> Historia</a></td>
									</tr>
									@endforeach																				
								</tbody>
							</table>
