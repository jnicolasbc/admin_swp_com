							...
							<table class="table table-striped" id="table-example">
								<thead>
									<tr>
										...
										<th class="text-center">Cinfirmar cita/No acptar Ciat/</th>
									</tr>
								</thead>
								<tbody align="center">
								@if($Appointment) 																				
									...
									<tr class="odd gradeX">	
                                        ...
                                        <td>
                                        <a href="{{url('clinic/confirmation-appointment')}}?cita_id={{$d->id}}" type="button" class="btn btn-info btn-transparent"><i class="fa fa-pencil-square-o"></i> Confirmar cita</a>																																												
