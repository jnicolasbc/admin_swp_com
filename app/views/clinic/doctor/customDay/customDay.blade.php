...
@section('content')
	...
	<div id="content">
		...
		<div class="row">
		    <div class="col-lg-12">
				<section class="panel">
					<a href="{{url('/doctor/custom-days/create')}}?agendaID={{$agendaID}}" class="btn btn-primary" style='margin-top: 10px; margin-left: 10px;'>
					    ...
					    <table class="table table-striped" id="table-example">
							...
							<tbody align="center"> 																				
                                ...
                                <tr class="odd gradeX"> 
							        ...
							        <td>
							        	<a href="{{url('/doctor/custom-days/'.$customdday->id.'/edit')}}" type="button" class="btn btn-info btn-transparent"><i class="fa fa-pencil-square-o"></i></a>
							        	{{ Form::open(array('class'=>'pull-right','url' => 'doctor/custom-days/'.$customdday->id)) }}
