		...
		<div class="row" style="height: 100%;">
			<div class="col-lg-12" style="height: 100%;">
                ...
                <!--
		            ...
		            <div id="main" style="height: 100%;">
		            	<div class="tabbable">
		            		<ul class="nav nav-tabs" data-provide="tabdrop">
		            			...
		            			<li><a href="#" onClick="$('#md-add-user').modal();" style="background-color: rgba(11, 114, 181, 0.18);"><i class="fa fa-plus"></i> Nuevo Paciante</a></li>
		            		</ul>
		            ...
		            ///////////////////////////////////////////////////////////////
		            -->
		            <div id="md-add-user" class="modal fade md-slideUp" tabindex="-1" data-width="450"  data-header-color="inverse">
		            	...
		            	<div class="modal-body" style="padding-bottom:0">
		            		<div class="errors_form1"></div>
		 	                {{Form::open(array('id' => 'register_user', 'class' => 'cmxform form-horizontal adminex-form', 'action' => 'ClinicDoctorsController@postaddPatient', 'files' => 'true'))}}
		            			{{ Form::hidden("agenda_id", $agenda->id) }}
		            			<label class="control-label">Nombre</label>
		            			<div class="form-group">
		            				{{ Form::text('first_name', NULL,['id'=>'patient', 'class' => 'form-control'])}}
		            			</div>

		            			<label class="control-label">Apellido</label>
		            			<div class="form-group">
		            				{{ Form::text('last_name', NULL,['id'=>'patient', 'class' => 'form-control'])}}
		            			</div>

		            			<label class="control-label">E-mail o Correo Electronico</label>
		            			<div class="form-group">
		            				{{ Form::text('email', NULL,['id'=>'patient', 'class' => 'form-control'])}}
		            			</div>
...
@section('js-script')
	$(document).ready(function() {	
	    ...
	    //petición al enviar el formulario de registro de pacientes
	    var form1 = $('#register_user');
	        ...
	        $.ajax({
	            ...
	            success: function (data) {
	            	if(data.success == false){
		                ...
		                new PNotify({
                            title: "<p>Paciente Agregadon exito</p>",
                            text: "<p>Un email ha sido enviado a "+data.email+" con su datos de aunteticacion</p>",
                            addclass: 'custom',
	  ...
	  $( "#slide-trash" ).droppable({
       ...
       error: function(){
         new PNotify({
			...
			droppable: true, 
			events: {
			        url: '{{url()}}/api/testing2?bussines={{$bussi}}', 
