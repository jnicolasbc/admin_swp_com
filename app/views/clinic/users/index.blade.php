				...
				<div id="content">
					<div class="row">
						...
						<div class="row">
								...
								<div class="col-lg-12">
										<section class="panel">
											<a href="{{url('/clinic/users/create')}}" class="btn btn-primary" style='margin-top: 10px; margin-left: 10px;'>
										    <i class="fa fa-pencil-square-o"></i> Nuevo
												...
												<div class="panel-body">
																...
																<table class="table table-striped" id="table-example">
																		...
																		<tbody align="center"> 																				
																				@foreach(UserReceptionist::where('clinic_id', Clinic::getClinicId())->get() as $d)
																					<?php
                                          ...
                                          $profile = Profile::where('user_id', $d->user_id)->first();
																					...
																					<tr class="odd gradeX">	
																						...
																						<td>
																							<a href="{{url('/clinic/users/'.$doc->id.'/edit')}}" type="button" class="btn btn-info btn-transparent" data-toggle="tooltip" data-placement="left" title="Editar"><i class="fa fa-pencil-square-o"></i></a>
                                  ...
                                  insert_brs: false
                                    ...
                                    <div id="form_notice_{{$d->id}}" style="display: none;">
                                      {{ Form::open(array('method'=>'get', 'class'=>'pf-form pform_custom','url' => 'clinic/users/'.$d->id)) }}
