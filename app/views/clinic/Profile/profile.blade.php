                ...
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                {{ Form::model($user, ['class' => 'cmxform form-horizontal adminex-form', 'files' => 'true', 'method' => 'post', 'action' =>'ClinicController@postAdminProfile']) }}
                                    ...
                                    <div class="form-group col-ms-12">
                                        ...
                                        <div class="col-md-4">
                                            <a href="#" id="password" data-type="text" data-pk="{{$user->id}}" data-placement="right" data-placeholder="Required" data-title="Enter New Password"></a>
                                        </div>
                                    </div>
