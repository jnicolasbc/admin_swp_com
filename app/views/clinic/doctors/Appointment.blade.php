				...
				<div class="col-lg-12">
					<section class="panel corner-flip">
                        <header class="panel-heading sm" data-color="theme-inverse">
                            <h2><strong>{{trans('main.agenda')}}</strong>.</h2>
						...
						<div class="panel-body">
		            		<ul class="nav nav-tabs" data-provide="tabdrop">
		            		    ...
		            		    <li ><a href="#" data-view="month" data-toggle="tab" class="change-view">{{trans('main.month')}}</a></li>
		            			<li class="active"><a href="#" data-view="agendaWeek" data-toggle="tab" class="change-view">{{trans('main.week')}}</a></li>
		            			<li><a href="#" data-view="agendaDay" data-toggle="tab" class="change-view">{{trans('main.day')}}</a></li>
