<nav id="menu"  data-search="close">
	<ul>
		...
		<li><span><i class="icon  fa fa-th-list"></i> {{trans('ad.clinics')}}</span>
			<ul>
				<li class="Label label-lg">{{trans('ad.clinics')}}</li>
				<li><a href="#"> {{trans('ad.clinics clinic add')}} </a></li>
				<li><a href="#"> {{trans('ad.clinics doctor add')}} </a></li>
				<li><a href="#">  {{trans('ad.clinics doctor search')}} </a></li>
			</ul>
		</li>
		<li><span><i class="icon  fa fa-th-list"></i> {{trans('ad.doctor')}}</span>
			<ul>
				<li class="Label label-lg">{{trans('ad.clinics add')}}</li>
				<li><a href="alwayMenu.html"> {{trans('ad.clinics doctor add')}} </a></li>
				<li><a href="hideUserPanel.html">  {{trans('ad.clinics doctor search')}} </a></li>
			</ul>
		</li>
		<li><span><i class="icon  fa fa-th-list"></i> {{trans('ad.paypal')}}</span>
			<ul>
				<li class="Label label-lg">{{trans('ad.clinics add')}}</li>
				<li><a href="alwayMenu.html"> {{trans('ad.clinics doctor add')}} </a></li>
				<li><a href="hideUserPanel.html">  {{trans('ad.clinics doctor search')}} </a></li>
		...
		<li><span><i class="icon  fa fa-th-list"></i> {{trans('ad.reports')}}</span>
			<ul>
				<li class="Label label-lg">{{trans('ad.clinics add')}}</li>
				<li><a href="alwayMenu.html"> {{trans('ad.clinics doctor add')}} </a></li>
				<li><a href="hideUserPanel.html">  {{trans('ad.clinics doctor search')}} </a></li>
		...
		<li><span><i class="icon  fa fa-th-list"></i> {{trans('ad.configuration')}}</span>
			<ul>
				<li class="Label label-lg">{{trans('ad.clinics add')}}</li>
				<li><a href="alwayMenu.html"> {{trans('ad.clinics doctor add')}} </a></li>
				<li><a href="hideUserPanel.html">  {{trans('ad.clinics doctor search')}} </a></li>
