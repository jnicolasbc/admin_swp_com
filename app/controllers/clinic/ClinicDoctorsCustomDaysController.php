...
class ClinicDoctorsCustomDaysController extends \BaseController {
	...
	public function show($id)
	{
        ...
        return View::make('clinic.doctors.customDay')
    ...
    {   
        ...
        return View::make('clinic.doctors.customDayAdd')->with('agendaID', $id);
    }
    ...
    public function store()
    {
        ...
        if ($validation->fails())
        {
            return Redirect::to('/clinic/doctor/custom-days/create')->withErrors($validation)->withInput();
        }
        else
        {   
            ...
            if($customDay){
                return Redirect::to('/clinic/doctor/custom-days/'.Input::get("id"))->withFlash_message("Guardado Exitosamente");
            }
            else
            {
              return Redirect::to('/clinic/doctor/custom-days/create')->withErrors("Error")->withInput();      
            }
